...
public class ChangeSortTooltipOnSortChange : MonoBehaviour
{
	...
	[Space]
	[SerializeField]
	private LocalizedString sortByNameString;

	[SerializeField]
	private LocalizedString sortByArtistString;

	[SerializeField]
	private LocalizedString sortByModifiedString;

	private void Start()
	{
		songList.SortTypeChanged += SongList_OnSortTypeChanged;
	}
