...
{
	[SerializeField]
	private Toggle strobePassToggle;

	[SerializeField]
	private Toggle extendedOptionsToggle;

	[SerializeField]
	private GameObject extendedOptionsPanel;
	...
	public void ToggleExtendedOptions(bool enabled)
	{
		...
		extendedOptionsToggle.transform.localEulerAngles = (float)(enabled ? 1 : 0) * 180f * Vector3.forward;
