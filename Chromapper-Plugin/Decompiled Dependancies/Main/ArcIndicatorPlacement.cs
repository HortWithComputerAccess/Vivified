...
public class ArcIndicatorPlacement : PlacementController<BaseArc, ArcIndicatorContainer, ArcGridContainer>, CMInput.INotePlacementActions
{
	[SerializeField]
	...
	{
		return new BeatmapObjectPlacementAction(spawned, conflicting, "Edited an arc.");
	}
	...
	{
		if (con is ArcIndicatorContainer arcIndicatorContainer)
		{
			if (arcIndicatorContainer.IndicatorType == IndicatorType.Head)
			{
				return (arcIndicatorContainer.ParentArc.ArcData.SongBpmTime - Atsc.CurrentSongBpmTime) * EditorScaleController.EditorScale;
			}
			if (arcIndicatorContainer.IndicatorType == IndicatorType.Tail)
			{
				return (arcIndicatorContainer.ParentArc.ArcData.TailSongBpmTime - Atsc.CurrentSongBpmTime) * EditorScaleController.EditorScale;
			}
		}
