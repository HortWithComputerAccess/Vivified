...
public class WaveformGenerator : MonoBehaviour
{
	...
	[FormerlySerializedAs("spectrogramGradient2d")]
	[GradientUsage(true)]
	...
	private void Start()
	{
		if (!(BeatSaberSongContainer.Instance.LoadedSong == null))
		{
			...
			AudioManager.GenerateFFT(BeatSaberSongContainer.Instance.LoadedSong, Settings.Instance.SpectrogramSampleSize, Settings.Instance.SpectrogramEditorQuality);
		}
	}
}
