...
public class SpectrogramSettingsUpdater : MonoBehaviour
{
	...
	private void Start()
	{
		Settings.NotifyBySettingName("SpectrogramBilinearFiltering", UpdateSpectrogramSettings);
		Settings.NotifyBySettingName("SpectrogramShift", UpdateSpectrogramSettings);
	...
	{
		Settings.ClearSettingNotifications("SpectrogramBilinearFiltering");
		Settings.ClearSettingNotifications("SpectrogramShift");
	}
}
